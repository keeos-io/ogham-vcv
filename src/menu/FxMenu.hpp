...
inline const std::vector<FieldSpec>& FieldSpecs() {
    static const std::vector<FieldSpec> specs = {
        ...
        {"CV Out mode",       "Envelope follower, or the raw bytebeat as a voltage",
                              {"Envelope of Out 1", "Envelope of Out 2",
                               "Out 1 as DC", "Out 2 as DC"}, 3},
        {"CV slew rise",      "Off to about 5 s",               {}, 99},
        {"CV slew fall",      "Independent of the rise",        {}, 99},
        {"CV hold",           "Sample and hold, DC modes only",
